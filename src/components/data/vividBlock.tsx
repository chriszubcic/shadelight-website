...
class VividBlock {
    ...
    // Accessor methods to expose individual properties, if needed
    static get title(): string {
        return this.vivid_block.title;
    }

    static get image(): string {
        return this.vivid_block.image;
    }

    static get description(): string {
        return this.vivid_block.description;
    }

    static get colours() {
        return this.vivid_block.colours;
    }

    static get minPrice(): number {
        return this.vivid_block.minPrice;
    }

    static get widthLimits(): number[] {
        return this.vivid_block.widthLimits;
    }

    static get heightLimits(): number[] {
        return this.vivid_block.heightLimits;
    }

    static get id(): string {
        return this.vivid_block.id;
    }

    // Method to get the CustomFabricProps object directly
    static getFabricProps(): CustomFabricProps {
        return this.vivid_block;
    }


    static get price(): number {
        return this.vivid_block.price
    }

    static get priceGroup(): number {
        return this.vivid_block.priceGroup
    }

}

export default VividBlock;
